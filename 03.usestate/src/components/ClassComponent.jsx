...
export class ClassComponent extends Component {
  /*
    ...
    - 두 컴포넌트 모두 사용이 가능하지만, 현재는 Function컴포넌트가 대세
    - state, LifeCycle의 개념은 초기에 Function 컴포넌트에는 존재하지 않았음
    - React Hook이 등장하면서 해당 기능들도 Function 컴포넌트에서 사용 가능
  ...
  */
  ...
  //  : 무거운 데이터들 일부라도 먼저 화면에 띄운 후 가져오기
  componentDidMount(){
